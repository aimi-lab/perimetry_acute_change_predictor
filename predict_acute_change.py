...
def get_data(dataset, use_all_samples=False):
...
def main():
    ...
    folder_name = './results/no_time_diff_restriction/{}'.format(dataset_name)
    ...
    clf_rf_opt = GridSearchCV(rf, parameters)
    ...
    clf_svm_opt = GridSearchCV(svc, parameters)            
